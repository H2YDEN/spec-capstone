...
CALL AddNewStoreSchedule('Monday', 4, '10:00:00', '22:00');
...
SET @name = NULL;
CALL GetStoreName(1, @name);
SELECT @name

SET @total = NULL;
CALL GetCartTotalPrice(2, @total);
SELECT @total
*/
-- CALL SetUserIsActive(1);
-- CALL SetUserInActive(1);
-- CALL SetStoreIsActive(1, FALSE);
